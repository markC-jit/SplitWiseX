...
import { useDisplayUsdMode } from "~~/hooks/web3/useDisplayUsdMode";
import { useTargetNetwork } from "~~/hooks/web3/useTargetNetwork";
import { useWatchBalance } from "~~/hooks/web3/useWatchBalance";
...
export const Balance = ({ address, className = "", usdMode }: BalanceProps) => {
  ...
  if (isError) {
    return (
      <div className="border-2 border-gray-300 rounded-md px-2 flex flex-col items-center max-w-fit cursor-pointer">
