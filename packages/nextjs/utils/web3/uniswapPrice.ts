import { getAlchemyHttpUrl } from "./alchemy";
import { CurrencyAmount, Token } from "@uniswap/sdk-core";
import { Pair, Route } from "@uniswap/v2-sdk";
import { Address, Chain, createPublicClient, fallback, http, parseAbi } from "viem";
...
type ChainWithTokenAddress = Chain & {
  nativeCurrencyTokenAddress?: string;
};

export const fetchPriceFromUniswap = async (targetNetwork: ChainWithTokenAddress): Promise<number> => {
  if (
